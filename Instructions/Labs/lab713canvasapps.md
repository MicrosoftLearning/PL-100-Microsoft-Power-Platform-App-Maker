...
## Part 1: Use Copilot to create a canvas app

In this lab, you will learn how to create a Real Estate Showing App with the assistance of Copilot for Power Apps, an AI-powered feature that provides suggestions and guidance for building Power Apps. This app will enable real estate agents to manage property listings and schedule showings more efficiently, enhancing their productivity and customer service.

Copilot for Power Apps uses artificial intelligence to suggest formulas, controls, and other elements that can be added to your app based on the context of what you are building. Copilot can help you save time and improve the quality of your app by providing suggestions for common tasks and functions.
...
6. Where the Copilot chat reads "What do you want to do with this table", enter the following prompt and submit:
   ...
   `Store Real Estate Property information, including ID, Address, Price, Size, Owner, and Owner Email.`
...
9. Respond in the Copilot chat:

   `Add a column for notes.`

10. Review the suggested Real Estate Property table. Compare your columns to the following and make any adjustments needed for them to align:
   - ID
   - Address
   - Price
   - Size
...
1. On the tree view, select **MainScreen1** > **ScreenContainer1** > **BodyContainer1** > **SideBarContainer1** > **RecordsGallery1** > **Subtitle1**.
    ![Subtitle1 in Tree View](01/media/Subtitle1.png)
...
1. Notice the Subtitle has been selected on the app preview. Select the **Copilot** icon near the Subtitle. 
   ...
   > **Note:**
   > If the Copilot button is not displaying: Navigate to **RecordsGallery1** in the tree view and select **Properties**, then select **Edit** for Fields. Update the Subtitle1 field to another column that you would like to display. Close the Data tab and skip to step #7.
